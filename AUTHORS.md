...
that does not exist, and because the copyright status of AI-assisted code is not settled in every
jurisdiction. Until that question is settled for this project, the license files name "the T-saur
