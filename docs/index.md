...
binary. Format v1 is frozen; the software is at 1.0.0-rc.1, with no tagged release or package
published yet. Apache-2.0 OR MIT, no account, no service.

Repository and README: <https://github.com/iulianbondari/t-saur>

## Start here

* [Installing](INSTALL.md): building from source (Rust 1.87 or newer); release packages once tagged.
